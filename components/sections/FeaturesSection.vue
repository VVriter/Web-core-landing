    ...
    <div class="container">
      <div class="section-header">
        ...
        <p class="section-description">
          Ми створюємо сайти, які працюють на ваш бізнес: приносять клієнтів, збільшують продажі та розвивають ваш бренд
        </p>
      </div>
...
const features = [
  {
    title: 'Результати для вашого бізнесу',
    description: 'Ми створюємо сайти, які реально працюють: збільшують продажі, приносять нових клієнтів та розвивають ваш бізнес в інтернеті.',
    icon: 'mdi:trending-up',
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&q=80'
  },
  {
    title: 'Ваш сайт працює скрізь',
    description: 'Кожен клієнт має побачити ваш бізнес ідеально - незалежно від того, чи він відкриває сайт на телефоні, планшеті або комп\'ютері.',
    icon: 'mdi:devices',
