...
const processSteps = [
  ...
  },
  {
    ...
    description: 'Перевіряємо, що все працює ідеально, після чого запускаємо ваш сайт. Далі ми завжди поруч, щоб допомогти розвивати проект.',
    icon: 'mdi:rocket-launch'
  },
  {
    title: 'Розвиток та оптимізація',
    description: 'Аналізуємо результати, додаємо нові можливості та вдосконалюємо сайт, щоб він продовжував приносити більше клієнтів та збільшувати ваш дохід.',
    icon: 'mdi:chart-line'
  }
]
